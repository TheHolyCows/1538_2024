...
if __name__ == "__main__":
    ...
    if ("red" in infile):
        ...
        outfile = str.replace(infile,"blue","red")
    ...
    if ("red" in infile):
        ...
        for item in infile_data["waypoints"]:
            if (item["anchor"] != 'null'):
                item["anchor"]["x"] = MIDPOINT_X + (MIDPOINT_X - item["anchor"]["x"])
            if (item["prevControl"] != None):
                item["prevControl"]["x"] = MIDPOINT_X + (MIDPOINT_X - item["prevControl"]["x"])
            if (item["nextControl"] != None):
                item["nextControl"]["x"] = MIDPOINT_X + (MIDPOINT_X - item["nextControl"]["x"])
            if (item["linkedName"] != None):
                item["linkedName"] = str.replace(item["linkedName"],"blue","red")
